package org.appxi.smartlib.app.dict;
...
class DictionaryViewer extends StackPane {
    ...
    protected void onSetAppStyle(VisualEvent event) {
        ...
        Optional.ofNullable(App.class.getResourceAsStream("web.css")).ifPresent(consumer);
    ...
    private void loadHtmlContent(boolean loadFromAll) {
        ...
        //
        buff.append("</head><body style=\"padding: 0 1rem;\">");
        //
        if (loadFromAll) {
